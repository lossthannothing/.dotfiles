...
#
# setup-nix-proxy.sh - A script to quickly configure a proxy for the Nix daemon.
#
# Usage:
#   ./setup-nix-proxy.sh http      # Set HTTP proxy
#   ./setup-nix-proxy.sh socks     # Set SOCKS5 proxy
#   ./setup-nix-proxy.sh off       # Clear proxy settings
#

# --- Configuration ---
# HTTP 代理地址和端口
HTTP_PROXY_URL="http://localhost:7897"

# SOCKS5 代理地址和端口
# 使用 socks5h:// 可以在代理端解析 DNS，通常是推荐的做法。
SOCKS_PROXY_URL="socks5h://localhost:10808"
...
Environment="httpss_proxy=$proxy_url" "http_proxy=$proxy_url" "all_proxy=$proxy_url"
EOF
